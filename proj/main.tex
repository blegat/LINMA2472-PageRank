...
\begin{align*}
  z^T v
  & = \sum_{i \in P} z_i v_i + \sum_{j \in \overline{P}} z_j v_j\\
  & = \sum_{i \in P} z_i v_i + \sum_{j \in \overline{P}} z_j\sum_{i \in P} v_i (1-c) v_j^{0_i}\\
  & = \sum_{i \in P} z_i v_i + \sum_{i \in P} v_i \sum_{j \in \overline{P}} (1-c) z_j v_j^{0_i}\\
  & = \sum_{i \in P} v_i \left(z_i + \sum_{j \in \overline{P}} (1-c) z_jv_j^{0_i}\right)\\
  & = w^T v_P
\end{align*}
...
Let \(l\) be the leak, i.e. \((1,l) \in E\) and \(l \in \overline{P}\).
Wlog, let \(l = n_{P}+1\).
...
If \(z_{i_1} = z_{i_2}\), \(i_2\) has no in-link from \(\overline{P}\) and \(i_1\) has at least one,
then we have that
